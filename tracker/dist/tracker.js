//#region ../../node_modules/.pnpm/@fingerprintjs+fingerprintjs@5.1.0/node_modules/@fingerprintjs/fingerprintjs/dist/fp.esm.js
var e = "5.1.0";
function t(e, t) {
...
var Ge = "mmMwWLliI0O&1", Ke = "48px", qe = [
	"monospace",
	"sans-serif",
	"serif"
...
function Ye() {
	return Ve(async (e, { document: t }) => {
		...
		}, s = (e, t) => o(`'${e}',${t}`), c = () => qe.map(o), l = () => {
			let e = {};
			for (let t of Je) e[t] = qe.map((e) => s(t, e));
			return e;
		}, u = (e) => qe.some((t, n) => e[n].offsetWidth !== i[t] || e[n].offsetHeight !== a[t]), d = c(), f = l();
		n.appendChild(r);
		for (let e = 0; e < qe.length; e++) i[qe[e]] = d[e].offsetWidth, a[qe[e]] = d[e].offsetHeight;
		return Je.filter((e) => u(f[e]));
	});
}
function Xe() {
...
function Qe(e) {
	let t = !1, n, r, [i, a] = $e();
	return et(i, a) ? (t = tt(a), e ? n = r = "skipped" : [n, r] = nt(i, a)) : n = r = "unsupported", {
		winding: t,
		geometry: n,
		text: r
	};
...
function nt(e, t) {
	rt(e, t);
	let n = at(e);
	return n === at(e) ? (it(e, t), [at(e), n]) : ["unstable", "unstable"];
}
function rt(e, t) {
...
function ft() {
	if (!(y() && Oe() && xe())) return pt();
}
function pt() {
	let e = screen, t = (e) => f(u(e), null), n = [t(e.width), t(e.height)];
	return n.sort().reverse(), n;
}
var mt = 2500, ht = 10, gt, _t;
function vt() {
	if (_t !== void 0) return;
	let e = () => {
		let t = xt();
		St(t) ? _t = setTimeout(e, mt) : (gt = t, _t = void 0);
	};
	e();
}
function yt() {
...
function bt() {
	let e = y() && Oe() && xe(), t = Se() && we();
	if (e || t) return () => Promise.resolve(void 0);
	let n = yt();
	return async () => {
		let e = await n(), t = (e) => e === null ? null : m(e, ht);
		return [
			t(e[0]),
			t(e[1]),
			t(e[2]),
...
function Mt() {
	...
	return e === "MacIntel" && y() && !be() ? ke() ? "iPad" : "iPhone" : e;
}
function Nt() {
...
async function Lt({ debug: e } = {}) {
	if (!Rt()) return;
	let t = It(), n = Object.keys(t), r = await zt([].concat(...n.map((e) => t[e])));
	e && Vt(t, r);
	let i = n.filter((e) => {
		let n = t[e];
...
async function zt(e) {
	...
	for (let t = 0; t < e.length; ++t) {
		...
		Bt(o), o.appendChild(n), i.appendChild(o), a[t] = n;
	}
...
function Jt() {
	if (matchMedia("(min-monochrome: 0)").matches) {
		for (let e = 0; e <= qt; ++e) if (matchMedia(`(max-monochrome: ${e})`).matches) return e;
...
function on() {
	return sn((e, t) => {
		...
		for (let r of Object.keys(an)) {
			let [i = {}, a = rn] = an[r], o = e.createElement("span");
			o.textContent = a, o.style.whiteSpace = "nowrap";
			for (let e of Object.keys(i)) {
				let t = i[e];
				t !== void 0 && (o.style[e] = t);
			}
			n[r] = o, t.append(e.createElement("br"), o);
		}
		for (let e of Object.keys(an)) r[e] = n[e].getBoundingClientRect().width;
		return r;
	});
}
function sn(e, t = 4e3) {
	return Ve((n, r) => {
		...
		return s.textContent = [...Array(t / 20 << 0)].map(() => "word").join(" "), a.appendChild(s), e(i, a);
...
var mn = -1, hn = -2, gn = new Set([
	...
	36795,
	38449
]), vn = ["FRAGMENT_SHADER", "VERTEX_SHADER"], yn = [
	"LOW_FLOAT",
	"MEDIUM_FLOAT",
	"HIGH_FLOAT",
	"LOW_INT",
	"MEDIUM_INT",
	"HIGH_INT"
], bn = "WEBGL_debug_renderer_info", xn = "WEBGL_polygon_mode";
function Sn({ cache: e }) {
	let t = wn(e);
	if (!t) return mn;
	if (!An(t)) return hn;
	let n = On() ? null : t.getExtension(bn);
	return {
...
function Cn({ cache: e }) {
	...
	for (let e of l) {
		let n = t[e];
		o.push(`${e}=${n}${gn.has(n) ? `=${t.getParameter(n)}` : ""}`);
	}
	if (n) for (let e of n) {
		if (e === bn && On() || e === xn && kn()) continue;
		...
		for (let e of En(n)) {
			let r = n[e];
			s.push(`${e}=${r}${_n.has(r) ? `=${t.getParameter(r)}` : ""}`);
		}
	}
	for (let e of vn) for (let n of yn) {
		let r = Tn(t, e, n);
		c.push(`${e}.${n}=${r.join(",")}`);
	}
...
function En(e) {
	return Object.keys(e.__proto__).filter(Dn);
}
function Dn(e) {
...
var Fn = "$ if upgrade to Pro: https://fingerprint.com/github/?utm_source=oss&utm_medium=referral&utm_campaign=confidence_score";
function In(e) {
	let t = Ln(e), n = Rn(t);
	return {
		score: t,
		comment: Fn.replace(/\$/g, `${n}`)
	};
}
function Ln(e) {
	if (Me()) return .4;
	if (y()) return be() && !(Oe() && xe()) ? .5 : .3;
...
function Hn(t) {
	...
	return {
		get visitorId() {
			return n === void 0 && (n = Vn(this.components)), n;
		},
		set visitorId(e) {
			n = e;
		},
...
function Wn(e, t) {
	let n = Date.now();
	return { async get(r) {
		let i = Date.now(), a = await e(), o = Hn(a);
...
var qn = {
	load: Kn,
	hashComponents: Vn,
	componentsToDebugString: Bn
}, Jn = "2.0.9", Yn = 500, Xn = "user-agent", Zn = "", Qn = "?", C = {
	FUNCTION: "function",
	OBJECT: "object",
	STRING: "string",
	UNDEFINED: "undefined"
}, w = "browser", T = "cpu", E = "device", D = "engine", O = "os", $n = "result", k = "name", A = "type", j = "vendor", M = "version", N = "architecture", er = "major", P = "model", tr = "console", F = "mobile", I = "tablet", L = "smarttv", R = "wearable", nr = "xr", rr = "embedded", ir = "fetcher", z = "inapp", ar = "brands", B = "formFactors", or = "fullVersionList", V = "platform", sr = "platformVersion", cr = "bitness", H = "sec-ch-ua", lr = H + "-full-version-list", ur = H + "-arch", dr = H + "-" + cr, fr = H + "-form-factors", pr = H + "-" + F, mr = H + "-" + P, hr = H + "-" + V, gr = hr + "-version", _r = [
	ar,
	or,
	F,
	P,
	...
	B,
	cr
], vr = "Amazon", yr = "Apple", br = "ASUS", xr = "BlackBerry", U = "Google", Sr = "Huawei", Cr = "Lenovo", wr = "Honor", Tr = "LG", Er = "Microsoft", Dr = "Motorola", Or = "Nvidia", kr = "OnePlus", Ar = "OPPO", jr = "Samsung", Mr = "Sharp", Nr = "Sony", Pr = "Xiaomi", Fr = "Zebra", Ir = "Chrome", Lr = "Chromium", W = "Chromecast", Rr = "Edge", zr = "Firefox", Br = "Opera", Vr = "Facebook", Hr = "Sogou", Ur = "Mobile ", Wr = " Browser", Gr = "Windows", G = typeof window !== C.UNDEFINED && window.navigator ? window.navigator : void 0, K = G && G.userAgentData ? G.userAgentData : void 0, Kr = function(e, t) {
	var n = {}, r = t;
	if (!Yr(t)) for (var i in r = {}, t) for (var a in t[i]) r[a] = t[i][a].concat(r[a] ? r[a] : []);
	...
	if (typeof e === C.OBJECT && e.length > 0) {
		for (var n in e) if (q(t) == q(e[n])) return !0;
		return !1;
	}
	return Xr(e) ? q(t) == q(e) : !1;
}, Yr = function(e, t) {
	for (var n in e) return /^(browser|cpu|device|engine|os)$/.test(n) || (t ? Yr(e[n]) : !1);
}, Xr = function(e) {
	return typeof e === C.STRING;
}, Zr = function(e) {
	if (e) {
		for (var t = [], n = $r(/\\?\"/g, e).split(","), r = 0; r < n.length; r++) if (n[r].indexOf(";") > -1) {
			var i = ti(n[r]).split(";v=");
			t[r] = {
				brand: i[0],
				version: i[1]
			};
	...
	return Xr(e) ? $r(/[^\d\.]/g, e).split(".")[0] : void 0;
}, J = function(e) {
	for (var t in e) if (e.hasOwnProperty(t)) {
		var n = e[t];
		typeof n == C.OBJECT && n.length == 2 ? this[n[0]] = n[1] : this[n] = void 0;
	}
	return this;
}, $r = function(e, t) {
	return Xr(t) ? t.replace(e, Zn) : t;
}, ei = function(e) {
	return $r(/\\?\"/g, e);
}, ti = function(e, t) {
	return e = $r(/^\s\s*/, String(e)), typeof t === C.UNDEFINED ? e : e.substring(0, t);
}, ni = function(e, t) {
	if (!(!e || !t)) for (var n = 0, r, i, a, o, s, c; n < t.length && !s;) {
		var l = t[n], u = t[n + 1];
		for (r = i = 0; r < l.length && !s && l[r];) if (s = l[r++].exec(e), s) for (a = 0; a < u.length; a++) c = s[++i], o = u[a], typeof o === C.OBJECT && o.length > 0 ? o.length === 2 ? typeof o[1] == C.FUNCTION ? this[o[0]] = o[1].call(this, c) : this[o[0]] = o[1] : o.length >= 3 && (typeof o[1] === C.FUNCTION && !(o[1].exec && o[1].test) ? o.length > 3 ? this[o[0]] = c ? o[1].apply(this, o.slice(2)) : void 0 : this[o[0]] = c ? o[1].call(this, c, o[2]) : void 0 : o.length == 3 ? this[o[0]] = c ? c.replace(o[1], o[2]) : void 0 : o.length == 4 ? this[o[0]] = c ? o[3].call(this, c.replace(o[1], o[2])) : void 0 : o.length > 4 && (this[o[0]] = c ? o[3].apply(this, [c.replace(o[1], o[2])].concat(o.slice(4))) : void 0)) : this[o] = c || void 0;
		n += 2;
	}
}, Y = function(e, t) {
	for (var n in t) if (typeof t[n] === C.OBJECT && t[n].length > 0) {
		for (var r = 0; r < t[n].length; r++) if (Jr(t[n][r], e)) return n === Qn ? void 0 : n;
	} else if (Jr(t[n], e)) return n === Qn ? void 0 : n;
	...
	return J.call(e.init, [
		...
		[D, [M]],
		[O, [M]]
	]), J.call(e.isIgnoreRgx, [[w, / ?browser$/i], [O, / ?os$/i]]), J.call(e.toString, [
		[w, [k, M]],
		[T, [N]],
		[E, [j, P]],
		[D, [k, M]],
	...
	var n = si.init[t], r = si.isIgnore[t] || 0, i = si.isIgnoreRgx[t] || 0, a = si.toString[t] || 0;
	function o() {
		J.call(this, n);
	}
	return o.prototype.getItem = function() {
		...
		return K ? K.getHighEntropyValues(_r).then(function(t) {
			return e.setCH(new li(t, !1)).parseCH().get();
		}) : e.parseCH().get();
	}, o.prototype.withFeatureCheck = function() {
		return e.detectFeature().get();
	}, t != $n && (o.prototype.is = function(e) {
		var t = !1;
		for (var n in this) if (this.hasOwnProperty(n) && !Jr(r, n) && q(i ? $r(i, this[n]) : this[n]) == q(i ? $r(i, e) : e)) {
			if (t = !0, e != C.UNDEFINED) break;
		} else if (e == C.UNDEFINED && t) {
			t = !t;
			break;
		}
		return t;
		...
		var e = Zn;
		for (var t in a) typeof this[a[t]] !== C.UNDEFINED && (e += (e ? " " : Zn) + this[a[t]]);
...
function li(e, t) {
	if (e ||= {}, J.call(this, _r), t) J.call(this, [
		[ar, Zr(e[H])],
		[or, Zr(e[lr])],
		[F, /\?1/.test(e[pr])],
		[P, ei(e[mr])],
	...
	else for (var n in e) this.hasOwnProperty(n) && typeof e[n] !== C.UNDEFINED && (this[n] = e[n]);
}
function X(e, t, n, r) {
	return J.call(this, [
		["itemType", e],
...
}, X.prototype.setCH = function(e) {
	return this.uaCH = e, this;
}, X.prototype.detectFeature = function() {
	if (G && G.userAgent == this.ua) switch (this.itemType) {
		case w:
			G.brave && typeof G.brave.isBrave == C.FUNCTION && this.set(k, "Brave");
			break;
		case E:
			!this.get(A) && K && K[F] && this.set(A, F), this.get(P) == "Macintosh" && G && typeof G.standalone !== C.UNDEFINED && G.maxTouchPoints && G.maxTouchPoints > 2 && this.set(P, "iPad").set(A, I);
			break;
		case O:
			!this.get(k) && K && K[V] && this.set(k, K[V]);
			break;
		case $n:
			var e = this.data, t = function(t) {
				return e[t].getItem().detectFeature().get();
			};
			this.set(w, t(w)).set(T, t(T)).set(E, t(E)).set(D, t(D)).set(O, t(O));
	}
	return this;
}, X.prototype.parseUA = function() {
	switch (this.itemType != $n && ni.call(this.data, this.ua, this.rgxMap), this.itemType) {
		case w:
			this.set(er, Qr(this.get(M)));
			break;
		case O:
			if (this.get(k) == "iOS" && this.get(M) == "18.6") {
	...
	switch (this.itemType) {
		...
		case D:
			...
			if (n) for (var i = 0; i < n.length; i++) {
				...
				this.itemType == w && !/not.a.brand/i.test(a) && (!r || /Chrom/.test(r) && a != Lr || r == Rr && /WebView2/.test(a)) && (a = Y(a, ai), r = this.get(k), r && !/Chrom/.test(r) && /Chrom/.test(a) || this.set(k, a).set(M, o).set(er, Qr(o)), r = a), this.itemType == D && a == Lr && this.set(M, o);
			}
			break;
		case T:
			var s = e[N];
			s && (s && e[cr] == "64" && (s += "64"), ni.call(this.data, s + ";", t));
			break;
		case E:
			if (e[F] && this.set(A, F), e[P] && (this.set(P, e[P]), !this.get(A) || !this.get(j))) {
				var c = {};
				ni.call(c, "droid 9; " + e[P] + ")", t), !this.get(A) && c.type && this.set(A, c.type), !this.get(j) && c.vendor && this.set(j, c.vendor);
			}
			if (e[B]) {
				var l;
				if (typeof e[B] != "string") for (var u = 0; !l && u < e[B].length;) l = Y(e[B][u++], ii);
				else l = Y(e[B], ii);
				this.set(A, l);
			}
			break;
		case O:
			...
			if (d) {
				var f = e[sr];
				d == Gr && (f = parseInt(Qr(f), 10) >= 13 ? "11" : "10"), this.set(k, d).set(M, f);
			}
			this.get(k) == Gr && e[P] == "Xbox" && this.set(k, "Xbox").set(M, void 0);
			break;
		case $n:
			var p = this.data, m = function(t) {
				return p[t].getItem().setCH(e).parseCH().get();
			};
			this.set(w, m(w)).set(T, m(T)).set(E, m(E)).set(D, m(D)).set(O, m(O));
	}
	return this;
};
function Z(e, t, n) {
	if (typeof e === C.OBJECT ? (Yr(e, !0) ? (typeof t === C.OBJECT && (n = t), t = e) : (n = e, t = void 0), e = void 0) : typeof e === C.STRING && !Yr(t, !0) && (n = t, t = void 0), n) if (typeof n.append === C.FUNCTION) {
		var r = {};
	...
	if (!(this instanceof Z)) return new Z(e, t, n).getResult();
	var o = typeof e === C.STRING ? e : n && n[Xn] ? n[Xn] : G && G.userAgent ? G.userAgent : Zn, s = new li(n, !0), c = t ? Kr(oi, t) : oi, l = function(e) {
		return e == $n ? function() {
			return new X(e, o, c, s).set("ua", o).set(w, this.getBrowser()).set(T, this.getCPU()).set(E, this.getDevice()).set(D, this.getEngine()).set(O, this.getOS()).get();
		} : function() {
			return new X(e, o, c[e], s).parseUA().get();
		};
	};
	return J.call(this, [
		["getBrowser", l(w)],
		...
		["setUA", function(e) {
			return Xr(e) && (o = ti(e, Yn)), this;
		}]
	]).setUA(o), this;
}
Z.VERSION = Jn, Z.BROWSER = qr([
	k,
	M,
	er,
	A
]), Z.CPU = qr([N]), Z.DEVICE = qr([
	P,
	j,
	A,
	tr,
...
var ui = async (e, t) => {
	...
	let t = fi(), n = {
		anonymousId: (await (await qn.load()).get()).visitorId,
		browser: t.browser,
		os: t.os,
		device: t.device
	};
	return (await di(e.baseUrl + e.uv.api, n)).data;
}, mi = (e, t) => {
	...
	gi(e, t), window.addEventListener("hashchange", (n) => {
		gi(e, t);
	...
	history.pushState = function() {
		n.apply(this, arguments), gi(e, t);
	};
	let r = history.replaceState;
	history.replaceState = function() {
		r.apply(this, arguments), gi(e, t);
	};
}, vi = -1, yi = (e) => {
...
}, Ci = () => Si()?.activationStart ?? 0, Q = (e, t = -1) => {
	let n = Si(), r = "navigate";
	return vi >= 0 ? r = "back-forward-cache" : n && (document.prerendering || Ci() > 0 ? r = "prerender" : document.wasDiscarded ? r = "restore" : n.type && (r = n.type.replace(/_/g, "-"))), {
		name: e,
		value: t,
		rating: "good",
		delta: 0,
...
function Ti(e, t) {
	return wi.get(e) || wi.set(e, new t()), wi.get(e);
}
var Ei = class {
	t;
	i = 0;
...
}, $ = -1, ki = /* @__PURE__ */ new Set(), Ai = () => document.visibilityState !== "hidden" || document.prerendering ? Infinity : 0, ji = (e) => {
	if (document.visibilityState === "hidden") {
		if (e.type === "visibilitychange") for (let e of ki) e();
		isFinite($) || ($ = e.type === "visibilitychange" ? e.timeStamp : 0, removeEventListener("prerenderingchange", ji, !0));
	}
}, Mi = () => {
	if ($ < 0) {
		let e = Ci();
		$ = (document.prerendering ? void 0 : globalThis.performance.getEntriesByType("visibility-state").filter(((t) => t.name === "hidden" && t.startTime > e))[0]?.startTime) ?? Ai(), addEventListener("visibilitychange", ji, !0), addEventListener("prerenderingchange", ji, !0), yi((() => {
			setTimeout((() => {
				$ = Ai();
			}));
		}));
	...
	Ni((() => {
		let n = Mi(), r, i = Q("FCP"), a = Di("paint", ((e) => {
			for (let t of e) t.name === "first-contentful-paint" && (a.disconnect(), t.startTime < n.firstHiddenTime && (i.value = Math.max(t.startTime - Ci(), 0), i.entries.push(t), r(!0)));
		}));
		a && (r = bi(e, i, Pi, t.reportAllChanges), yi(((n) => {
			i = Q("FCP"), r = bi(e, i, Pi, t.reportAllChanges), xi((() => {
	...
	let n = Mi();
	Fi(Oi((() => {
		let r, i = Q("CLS", 0), a = Ti(t, Ei), o = (e) => {
			for (let t of e) a.h(t);
			a.i > i.value && (i.value = a.i, i.entries = a.o, r());
		}, s = Di("layout-shift", o);
		s && (r = bi(e, i, Ii, t.reportAllChanges), n.onHidden((() => {
			o(s.takeRecords()), r(!0);
		})), yi((() => {
			a.i = 0, i = Q("CLS", 0), r = bi(e, i, Ii, t.reportAllChanges), xi((() => r()));
		})), setTimeout(r));
	})));
}, Ri = 0, zi = Infinity, Bi = 0, Vi = (e) => {
	for (let t of e) t.interactionId && (zi = Math.min(zi, t.interactionId), Bi = Math.max(Bi, t.interactionId), Ri = Bi ? (Bi - zi) / 7 + 1 : 0);
}, Hi, Ui = () => Hi ? Ri : performance.interactionCount ?? 0, Wi = () => {
	"interactionCount" in performance || Hi || (Hi = Di("event", Vi, {
		type: "event",
		buffered: !0,
		durationThreshold: 0
	}));
	...
	p;
	v() {
		Gi = Ui(), this.u.length = 0, this.l.clear();
	}
	L() {
		let e = Math.min(this.u.length - 1, Math.floor((Ui() - Gi) / 50));
		return this.u[e];
	}
	h(e) {
		if (this.m?.(e), !e.interactionId && e.entryType !== "first-input") return;
		let t = this.u.at(-1), n = this.l.get(e.interactionId);
		if (n || this.u.length < 10 || e.duration > t.P) {
			if (n ? e.duration > n.P ? (n.entries = [e], n.P = e.duration) : e.duration === n.P && e.startTime === n.entries[0].startTime && n.entries.push(e) : (n = {
				...
				let e = this.u.splice(10);
				for (let t of e) this.l.delete(t.id);
			}
			this.p?.(n);
		}
	}
	...
	document.visibilityState === "hidden" ? e() : (e = Oi(e), addEventListener("visibilitychange", e, {
		once: !0,
		capture: !0
	}), t((() => {
	...
	Ni((() => {
		Wi();
		let r, i = Q("INP"), a = Ti(t, Ki), o = (e) => {
			qi((() => {
				for (let t of e) a.h(t);
				let t = a.L();
				t && t.P !== i.value && (i.value = t.P, i.entries = t.entries, r());
			}));
		}, s = Di("event", o, { durationThreshold: t.durationThreshold ?? 40 });
		r = bi(e, i, Ji, t.reportAllChanges), s && (s.observe({
			type: "first-input",
			buffered: !0
		}), n.onHidden((() => {
			o(s.takeRecords()), r(!0);
		})), yi((() => {
			a.v(), i = Q("INP"), r = bi(e, i, Ji, t.reportAllChanges);
		})));
	}));
}, Xi = async (e, t) => {
	...
	f.disconnect(), a = d, Yi((e) => {
		o = e.value;
	}), Li((e) => {
		s = e.value;
	}), window.addEventListener("visibilitychange", () => {
		document.visibilityState === "hidden" && ui(n, {
			visitorId: e,
			fp: r,
			fcp: i,
			lcp: a,
	...
	async init() {
		return this.initPromise ||= (async () => {
			let e = this.config;
			this.visitorId = await pi(e), mi(this.visitorId, e), hi(this.visitorId, e), _i(this.visitorId, e), Xi(this.visitorId, e);
		})(), this.initPromise;
	}
	async setUserId(e) {
		await this.init(), await di(this.config.baseUrl + this.config.uv.updateApi, {
